...
import ClassePeriodsModal from "./ClassePeriodsModal";
  ...
  return (
    <Box>
      ...
      >
        ...
        {classperiodsPermissions && classperiodsPermissions.includes("create") ? (
          <Button
            startIcon={<AddIcon />}
            variant="contained"
            size="small"
        ...
        >
          <Box sx={style}>
            <ClassePeriodsModal handleClose={handleClose} accessToken={accessToken} />
          </Box>
        </Modal>
        <Backdrop
