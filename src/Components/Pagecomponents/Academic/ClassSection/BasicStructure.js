...
const page = ({session}) => {
  ...
  // Extracting permissions for the "classsection" submenu
  ...
  return (
    <Box>
      ...
      >
        ...
        {classsectionPermissions && classsectionPermissions.includes("create") ? (
          <Button
            startIcon={<AddIcon />}
            variant="contained"
            size="small"
        ...
        >
          <Box sx={style}>
            <SectionModal handleClose={handleClose} accessToken={accessToken} />
          </Box>
        </Modal>
        <Backdrop
