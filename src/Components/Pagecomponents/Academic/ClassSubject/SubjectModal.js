        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row", gap: "3px" }}>
                  <Typography sx={{ ml: "15px" }}>Subject Code</Typography>
                  <Typography sx={{ color: "#786CF1", fontSize: "20px" }}>
                    *
                  </Typography>
                </Box>
            ...
            <Grid item xs={12} sm={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row", gap: "3px" }}>
                  <Typography sx={{ ml: "15px" }}>Subject</Typography>
                  <Typography sx={{ color: "#786CF1", fontSize: "20px" }}>
                    *
                  </Typography>
                </Box>
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                {/* {errors.image && <p>{errors.image.message}</p>} */}
                <Icon className={classes.icon} icon="ep:upload-filled" />
                {/* <CloudUploadIcon className={classes.icon} /> */}
                <Box className={classes.text}>
            ...
            <Grid item sm={6} xs={12}>
              ...
              >
                ...
                <Icon className={classes.icon} icon="teenyicons:pdf-solid" />
                <Box className={classes.text}>
