...
const page = ({session, SubjectTypeListData}) => {
  ...
  return (
    <Box>
      ...
      >
        ...
        {subjectPermissions && subjectPermissions.includes("create") ? (
          <Button
            startIcon={<AddIcon />}
            variant="contained"
            size="small"
        ...
        >
          <Box sx={style}>
            <SubjectModal handleClose={handleClose} accessToken={accessToken} SubjectTypeListData={SubjectTypeListData}/>
          </Box>
        </Modal>
        <Backdrop
