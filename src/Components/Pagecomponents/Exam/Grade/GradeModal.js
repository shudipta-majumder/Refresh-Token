        ...
        >
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  <Typography sx={{ ml: "15px" }}>Grade</Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  <Typography sx={{ ml: "15px" }}>Start Mark</Typography>
                  <Typography sx={{ color: "#786CF1", fontSize: "20px" }}>
                    *
                  </Typography>
                </Box>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  <Typography sx={{ ml: "15px" }}>End Mark</Typography>
                  <Typography sx={{ color: "#786CF1", fontSize: "20px" }}>
                    *
                  </Typography>
                </Box>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  <Typography sx={{ ml: "15px" }}>Point</Typography>
                  <Typography sx={{ color: "#786CF1", fontSize: "20px" }}>
                    *
                  </Typography>
                </Box>
            ...
            <Grid item xs={12}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row" }}>
                  <Typography sx={{ ml: "15px" }}>Serial No</Typography>
                  <Typography sx={{ color: "#786CF1", fontSize: "20px" }}>
                    *
                  </Typography>
                </Box>
