...
const FeesDiscountModal = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      percentage: editingRow ? editingRow?.percentage : "",
      amount: editingRow ? editingRow?.amount : "",
      description: editingRow ? editingRow?.description : "",
      remarks: editingRow ? editingRow?.remarks : "",
    },
    ...
    try {
      if (editingRow) {
        response = await fetch(
          `${process.env.NEXT_PUBLIC_HOST}/fees/api/fees-discount/detail/${editingRow.id}`,
          {
            method: "PUT",
            headers: {
  ...
  console.log("check id:", editingRow);
...
export default FeesDiscountModal;
