...
import FeesDiscountModal from "./FeesDiscountModal";
import FeesDiscountAddModal from "./FeesDiscountAddModal";
...
const columns = [
  ...
  { id: "code", label: "Code", align: "center", sortable: true },
  { id: "percentage", label: "Percentage", align: "center", sortable: true },
...
const FeesDiscountTable = ({ session }) => {
  ...
  useEffect(() => {
    fetch(
      `${process.env.NEXT_PUBLIC_HOST}/fees/api/fees-discount?page_number=${
        page + 1
...
export default FeesDiscountTable;
