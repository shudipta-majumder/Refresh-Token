        ...
        >
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={12} md={3}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row", gap: "3px" }}>
                  <Typography sx={{ ml: "15px" }}>Empolyee</Typography>
                </Box>
                <Controller
                  name="empolyee"
                  control={control}
            ...
            <Grid item xs={12} sm={12} md={3}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row", gap: "3px" }}>
                  <Typography sx={{ ml: "15px" }}>Leave Type</Typography>
                </Box>
                <Controller
                  name="leavetype"
                  control={control}
            ...
            <Grid item xs={12} sm={12} md={3}>
              ...
              >
                <Box sx={{ display: "flex", flexDirection: "row", gap: "3px" }}>
                  <Typography sx={{ ml: "15px" }}>Total Leave Days</Typography>
                </Box>
                <Controller
                  name="totaldays"
                  control={control}
