...
const page = ({session}) => {
  ...
  // Extracting permissions for the "Board" submenu
  ...
  return (
    <Box>
      ...
      >
        ...
        {BoardPermissions && BoardPermissions.includes("create") ? (
          <Button
            startIcon={<AddIcon />}
            variant="contained"
            size="small"
        ...
        >
          <Box sx={style}>
            <BoardModal handleClose={handleClose} accessToken={accessToken}/>
          </Box>
        </Modal>
        <Backdrop
