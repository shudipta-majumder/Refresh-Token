...
const page = ({session}) => {
  ...
  // Extracting permissions for the "LeaveType" submenu
  ...
  return (
    <Box>
      ...
      >
        ...
        {LeaveTypePermissions && LeaveTypePermissions.includes("create") ? (
          <Button
            startIcon={<AddIcon />}
            variant="contained"
            size="small"
        ...
        >
          <Box sx={style}>
            <LeaveTypeModal handleClose={handleClose} accessToken={accessToken}/>
          </Box>
        </Modal>
        <Backdrop
