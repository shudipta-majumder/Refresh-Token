...
const page = ({session}) => {
  ...
  // Extracting permissions for the "Shift" submenu
  ...
  return (
    <Box>
      ...
      >
        ...
        {ShiftPermissions && ShiftPermissions.includes("create") ? (
          <Button
            startIcon={<AddIcon />}
            variant="contained"
            size="small"
        ...
        >
          <Box sx={style}>
            <ShiftModal handleClose={handleClose} accessToken={accessToken}/>
          </Box>
        </Modal>
        <Backdrop
