...
const SingleStudentAdmissionDetails = ({
  Controller,
  versionData,
  classNameData,
  sessionData,
  ...
  console.log("seesion id data", sessionId);
  console.log("class id data", classnameId);
...
export default SingleStudentAdmissionDetails;
